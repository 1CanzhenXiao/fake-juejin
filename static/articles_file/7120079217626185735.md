> https://www.rectcircle.cn/posts/chromeos-experience/
...
* ChromeOS 可以在 Linux 子系统中安装 Linux GUI 程序，因此可以直接安装如 <span data-word-id="37427572" class="abbreviate-word">VSCode</span>、Jetbrains 等 <span data-word-id="484" class="abbreviate-word">IDE</span>，开发者软件生态丰富。
...
* 发布日期: 2022-05-31
* HASH(<span data-word-id="720" class="abbreviate-word">sha</span>256): 8066c8e08129<span data-word-id="574" class="abbreviate-word">bd</span>85838c00b5c96fb12a192b87e668657<span data-word-id="28518364" class="abbreviate-word">ca</span>73634ecbf763<span data-word-id="628" class="abbreviate-word">ee</span>8d2
...
这里通过 `shell` 命令，可以打开一个 <span data-word-id="36908372" class="abbreviate-word">bash</span> 终端，这个终端运行在 ChromeOS 所在 Linux 内核中，用户为 chronos。
