...
## 介绍
此项目为仿掘金网页版首页，是第四届字节跳动青训营的项目作业。依靠`python`的`flask`框架完成后端，以及主要用前端三剑客`HTML， CSS， JavaScript`大致实现掘金前端的网页布局。
...
│  │      
│  ├─json
│  │      all_article_info.json
│  │      all_user_info.json
│  │      IOS_article_info.json
│  │      人工智能_article_info.json
│  │      代码人生_article_info.json
│  │      前端_article_info.json
│  │      后端_article_info.json
│  │      安卓_article_info.json
│  │      开发工具_article_info.json
│  │      阅读_article_info.json
│  │      
│  ├─main_article_temp
│  │      文章列表加载时的格式.html
│  │      
